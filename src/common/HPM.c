...
/**
 * Recebe uma entrada de configuraï¿½ï¿½o de batalha atravï¿½s de plugins registrados.
 *
 * @param[in]  w1  Nome da entrada de configuraï¿½ï¿½o.
 * @param[out] value Onde o resultado de configuraï¿½ï¿½o serï¿½ salvo
 * @retval false No caso de dados nï¿½o encontrados
 */
